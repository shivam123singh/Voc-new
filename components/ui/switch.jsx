...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-3 w-[14px] rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-2 data-[state=unchecked]:translate-x-0"
      )} />
  </SwitchPrimitives.Root>
))
