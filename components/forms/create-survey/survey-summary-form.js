...
const SurveySummaryForm = () => {
    ...
    return (
        <div>
            ...
            <p className="text-[13px] text-grey-700">User satisfaction survey for the MTN 5G service</p>
            ...
            <div>
                {summaryInfo.map((info) => (
                    <div className="flex text-xs py-3 items-center" key={info.key}>
                        ...
                        <p className={
                            classNames(
                                `${info.key === 'Status' ? 'w-fit ml-4 font-medium' : 'w-[60%]'} whitespace-nowrap text-ellipsis px-4 py-[5px] rounded`,
                                info.resp === "active" &&
                                "text-green bg-green-100",
                                info.resp === "inactive" &&
                                "text-dark bg-dark-100",
                                info.resp === "draft" &&
                                "text-navyblue bg-navyblue-100",
            ...
            <div className="flex mt-4 whitespace-nowrap text-ellipsis text-xs w-full justify-between">
                <Button className="flex items-center font-normal px-6" variant="outline">
